...
from .perturbations import alpha_stable, beta, weibull, gama, pareto
...
class LimeTabularExplainer(object):
    ...
    def __init__(self,
        ...
        self.base = LimeBase(kernel_fn, verbose, random_state=self.random_state, surrogate_regressor=surrogate_regressor)
    ...
    def explain_instance(self,
        ...
        Args:
            ...
            surrogate_regressor: sklearn regressor to use in explanation. Defaults
                to Ridge regression in LimeBase. Must have surrogate_regressor.coef_
                and 'sample_weight' as a parameter to surrogate_regressor.fit()
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             ret_exp.local_pred[label]) = self.base.explain_instance_with_data(
                    ...
                    label,
                    num_features,
                    surrogate_regressor=surrogate_regressor,
