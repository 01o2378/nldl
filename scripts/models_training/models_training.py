...
def load_data(print_details=False, encode_labels=True):
    ...
    train_data_path = os.path.abspath(os.path.join(os.path.dirname( __name__ ), '..', '..', DATA_DIR, DATASET_DIR, 'train.csv'))
    val_data_path = os.path.abspath(os.path.join(os.path.dirname( __name__ ), '..', '..', DATA_DIR, DATASET_DIR, 'train.csv'))
    test_data_path = os.path.abspath(os.path.join(os.path.dirname( __name__ ), '..', '..', DATA_DIR, DATASET_DIR, 'train.csv'))
...
if __name__ == '__main__':
    ...
    # n_estimators=100/random_state=42/min_samples_split=2/max_depth=30/max_features=sqrt/min_samples_leaf=1
    ...
    # n_estimators=200/max_depth=6/learning_rate=0.1/subsample=0.8/colsample_bytree=0.8/min_child_weight=1
    ...
    # random_state=42/min_samples_split=2/max_depth=30/min_samples_leaf=1/max_features=sqrt
